...
Route::get('/', function () {
    return '<script>alert("anda tidak diundang")</script>';
    // $data = App\Models\Sezione::all();
    // return view('welcome',compact('data'));
});

Route::get('/orang/{slug}', [PageController::class,'show']);
...
Route::group(['middleware' => ['role:admin']], function () {
    ...
    //sezione
    Route::get('/home/orang', [DashboardController::class,'orang']);
    Route::get('/home/update', [SezioneController::class,'update']);
    // Route::get('/home/delete', [SezioneController::class,'delete']);
...
Route::group(['middleware' => ['role:admin,orang']], function () {
