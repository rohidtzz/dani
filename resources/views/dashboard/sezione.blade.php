                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Modal create undangan</h5>
                        ...
                        <form method="POST" action="{{ url('/home/pages/create') }}" enctype="multipart/form-data">
                            ...
                            {{-- <input type="hidden" name="id" value="{{ $all->id }}"> --}}
                              ...
                              <div class="mb-3">
                                ...
                                <input type="text" name="slug" class="form-control" required id="exampleInputEmail1" aria-describedby="emailHelp">
                                <div id="emailHelp" class="form-text"></div>
                              </div>
                    </div>
              ...
              <table class="table align-items-center mb-0">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Link</th>
                    ...
                    <td>
                        <div class="d-flex flex-column  text-center justify-content-center">
                            <h6 class="mb-0 text-sm text-center">
                                {{-- <div data-value="Https://danidananisah.hidtzz.my.id/orang/{{ $a->slug }}" id="myInput"></div> --}}
                                <button class="btn btn-success" onclick="myFunction('{{ $a->slug }}')">Copy Link</button>
                                <script>
                                    function myFunction(s) {
                                      // Get the text field
                                    //   let copyText = document.getElementById("myInput");

                                    //   copyText.dataset.value.empty()
                                    //   console.log('Https://danidananisah.hidtzz.my.id/orang/'+s)

                                      // Select the text field
                                    //   copyText.select();
                                    //   copyText.setSelectionRange(0, 99999);
                                    let text = 'Https://danidananisah.hidtzz.my.id/orang/'+s

                                      // Copy the text inside the text field
                                      navigator.clipboard.writeText(text);
                                    //   let a = copyText.dataset.value = null

                                      // Alert the copied text
                                    //   alert("Copied the text: " + copyText.value);
                                    }
                                    </script>
                                {{-- Https://danidananisah.hidtzz.my.id/orang/{{ $a->slug }} --}}
                            </h6>
                          </div>
                    </td>
